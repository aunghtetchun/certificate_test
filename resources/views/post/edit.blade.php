    ...
    <div class="row justify-content-start" style="position: fixed">
        <div class="col-12">
            <div class="pb-3">
                ...
                <span class="mx-2"><i class="fas fa-angle-right"></i></span>
                <span class="text-uppercase">Edit Certificate</span>
            </div>
        </div>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('post.update',$post->id) }}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <div class="form-inline d-flex justify-content-center align-items-center">
                                <div class="position-relative">
                                    ...
                                    <img src="{{ asset("user_thumbnail/".$post->photo) }}"
                                         style="height: 200px; max-width: 98%;" class="mr-2 rounded current-img" alt="">
                                </div>
                                <input type="hidden" name="original_user_photo" value="{{ $post->photo }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="name" id="title" value="{{$post->name}}" placeholder="Name">
                        </div>
                        <div class="form-group">
                            <label for="nrc">Nrc</label>
                            <input type="text" class="form-control" name="nrc" id="title" value="{{$post->nrc}}" placeholder="Nrc">
                        </div>
